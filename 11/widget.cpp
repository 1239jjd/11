...
void Widget::paintEvent(QPaintEvent *event)
{
    ...
    QPixmap background(":/new/prefix1/img/background.png");
...
{
    QString myresource;
    myresource = QFileDialog::getOpenFileName(this, tr("选择视频或音频"), "D:\\study\\CITY\\class",
...
void Widget::on_Begin_clicked()
{
    if(is_playing == 0){
        myplayer->play();
        ui->Begin->setStyleSheet("QPushButton#Begin{border-image:url(:/new/prefix1/img/stop1.png);}");
        is_playing = 1;
    }
    else{
        myplayer->pause();
        ui->Begin->setStyleSheet("QPushButton#Begin{border-image:url(:/new/prefix1/img/play2.png);}");
        is_playing = 0;
    }
}
